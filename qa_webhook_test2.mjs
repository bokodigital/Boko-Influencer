...
const payload = {
  ...
  customer: { id: 999000222 },
  financial_status: "paid",
  currency: "AUD",
  subtotal_price: "199.00",
  total_price: "169.15",
  total_discounts: "29.85",
  discount_codes: [ { code: "TEST10", amount: "29.85", type: "percentage" } ],
  note_attributes: [],
  line_items: [ { title: "QA Test Product", price: "199.00", quantity: 1 } ],
};
...
const res = await fetch('https://boko-influencer.replit.app/webhooks/orders/create', {
  ...
  headers: {
    ...
    'X-Shopify-Webhook-Id': 'qa-test2-' + orderId,
